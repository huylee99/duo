...
const UpdateSocials = () => {
  ...
  } = useForm<UpdateSocialsFields>({ resolver: zodResolver(updateSocialsValidatorSchema), defaultValues: { facebook: "", instagram: "", discord: "" } });
    ...
    <section className="space-y-4">
      ...
      <form onSubmit={onSubmit}>
        <div className="border border-border rounded-tr-md rounded-tl-md p-6">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Input {...register("facebook")} type="text" className="focus-visible:border-muted" autoComplete="off" aria-autocomplete="none" placeholder="https://www.facebook.com/nhathuy.le.587268" />
            </div>
            <div className="space-y-2">
              <Label className="text-base" htmlFor="instagram">
                Instagram
              </Label>
              <Input {...register("instagram")} type="text" className="focus-visible:border-muted" autoComplete="off" aria-autocomplete="none" placeholder="https://www.instagram.com/thaihoang1991" />
            </div>
            <div className="space-y-2">
              <Label className="text-base" htmlFor="discord">
                Discord
              </Label>
              <Input {...register("discord")} type="text" className="focus-visible:border-muted" autoComplete="off" aria-autocomplete="none" placeholder="https://discord.gg/8Uu78TPk" />
            </div>
          </div>
        </div>
        <footer className="border flex items-center border-border border-t-transparent rounded-br-md rounded-bl-md px-6 py-3 bg-muted gap-10">
          ...
          <Button className="h-8 ml-auto" size="sm" disabled={isSafeToSubmit}>
            Lưu
          </Button>
        </footer>
      </form>
